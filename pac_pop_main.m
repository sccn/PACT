...
try % try to find stored parameters
    ...
    'uilist',...
       {{'style' 'text' 'string' 'Phase freq range [lohz hihz]'}                    {'style' 'edit' 'string' num2str(EEG.pac.lfoPhase)   } ...
        ...
        {'style' 'text' 'string' 'Sampling pool'}                                   {'style' 'popupmenu' 'string' 'each channel|all channels|handpicked (Mobilab; deprecated)|EEGLAB''s events with +/-ms window' 'tag' 'hfoPool' 'value' EEG.pac.hfoPool} ...
    ...
    'uilist',...
       {{'style' 'text' 'string' 'Phase freqs [lohz hihz]'}                         {'style' 'edit' 'string' '1 2'   } ...
        ...
        {'style' 'text' 'string' 'Sampling pool'}                                   {'style' 'popupmenu' 'string' 'each channel|all channels|handpicked (Mobilab; deprecated)|EEGLAB''s events with +/-ms window' 'tag' 'hfoPool' 'value' 1} ...
        {'style' 'text' 'string' 'If EEGLAB''s events, select event and win size [+/- ms]'} {'style' 'popupmenu' 'string' dropDownStrings 'value' 1} {'style' 'edit' 'string' ''} ...
