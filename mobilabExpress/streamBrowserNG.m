...
% History
% ver 1.0 03/28/2014 by Makoto. Modified path setting method to the 'skin' folder
...
% set file separator type: Makoto 03/28/2014
if ispc
    SLASH = '\';
else
    SLASH = '/';
end
streamBreowserNG_Root = fileparts(which('streamBrowserNG.m'));
skinImagePath         = [streamBreowserNG_Root SLASH 'skin'];
...
CData = imread([skinImagePath SLASH '32px-Dialog-apply.svg.png']);set(handles.connectLine,'CData',CData,'BackgroundColor',mobilab.preferences.gui.buttonColor);
CData = imread([skinImagePath SLASH '32px-Gnome-edit-clear.svg.png']);set(handles.deleteLine,'CData',CData,'BackgroundColor',mobilab.preferences.gui.buttonColor);
CData = imread([skinImagePath SLASH '32px-Gnome-media-seek-backward.svg.png']);set(handles.play_rev,'CData',CData,'BackgroundColor',mobilab.preferences.gui.buttonColor);
CData = imread([skinImagePath SLASH '32px-Gnome-media-seek-forward.svg.png']);set(handles.play_fwd,'CData',CData,'BackgroundColor',mobilab.preferences.gui.buttonColor);
CData = imread([skinImagePath SLASH '32px-Gnome-preferences-system.svg.png']); set(handles.settings,'CData',CData,'BackgroundColor',mobilab.preferences.gui.buttonColor);
CData = imread([skinImagePath SLASH '32px-Gnome-media-seek-backward.svg.png']);set(handles.previous,'CData',CData,'BackgroundColor',mobilab.preferences.gui.buttonColor);
CData = imread([skinImagePath SLASH '32px-Gnome-media-seek-forward.svg.png']);set(handles.next,'CData',CData,'BackgroundColor',mobilab.preferences.gui.buttonColor);
CData = imread([skinImagePath SLASH '32px-Gnome-media-playback-start.svg.png']);set(handles.play,'CData',CData,'BackgroundColor',mobilab.preferences.gui.buttonColor);
...
set(handles.play,'userData',{imread([skinImagePath SLASH '32px-Gnome-media-playback-start.svg.png']) imread([skinImagePath SLASH '32px-Gnome-media-playback-pause.svg.png'])});
